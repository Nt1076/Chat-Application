...
//margin: EdgeInsets.symmetric(vertical: 50,horizontal: 20),
        ...
        Padding(
          ...
          child: Row(
           ...
           : Text("ChatUp",style: TextStyle(
              color: Color(0Xffc199cd),fontSize: 22,fontWeight: FontWeight.bold
            ),),
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                     Text(data["Name"],style: TextStyle(color:Colors.black,fontSize: 18 ,fontWeight: FontWeight.bold),),
                   SizedBox(height: 8,),
